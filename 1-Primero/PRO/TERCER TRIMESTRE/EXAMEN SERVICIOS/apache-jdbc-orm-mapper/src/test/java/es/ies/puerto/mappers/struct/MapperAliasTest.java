...
public class MapperAliasTest {
    ...
    public void testAliasToAliasDTO() {
        ...
        AliasDTO aliasDTO = IMapperAlias.INSTANCE.aliasToAliasDTO(alias);
    ...
    public void testAliasToAliasDTONull() {
        AliasDTO aliasDTO = IMapperAlias.INSTANCE.aliasToAliasDTO(null);
    ...
    public void testAliasDTOToAliasNull() {
        Alias alias = IMapperAlias.INSTANCE.aliasDTOToAlias(null);
