...
public class MappersEquipamiento {
    
    public static Equipamiento DTOToEquipamineto(EquipamientoDTO equipamientoDTO){
    ...
    public static EquipamientoDTO equipamientoToDTO(Equipamiento equipamiento){
